...
export function Contact() {
  ...
  // Contact Information (Phone & Address Removed)
  const rows = [
    {
      icon: Mail,
      label: "Email",
  ...
  return (
    ...
    >
      <SectionHead
        index="07"
        eyebrow="Contact"
        title="Let's build growth together"
      />
      ...
      <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-8">
            ...
            const Inner = (
              <>
                ...
                <div className="min-w-0">
                  <p className="text-xs uppercase tracking-[0.25em] soft mb-1">
                    {r.label}
                  </p>
        ...
        <Reveal delay={0.1}>
          <form
            onSubmit={submit}
            className="glass rounded-3xl p-7 sm:p-9 flex flex-col gap-5"
          ...
          >
            <div className="grid sm:grid-cols-2 gap-5">
              <div className="flex flex-col gap-2">
                <label
                  ...
                  className="text-xs uppercase tracking-[0.25em] soft"
                >
                  Name
                </label>
                <input
                  ...
                  className="bg-transparent border border-input rounded-xl px-4 py-3 text-sm outline-none focus:border-aqua transition-colors"
                />
              </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="bg-transparent border border-input rounded-xl px-4 py-3 text-sm outline-none focus:border-aqua transition-colors resize-none"
              />
            </div>
